...
<head>
    <meta charset="UTF-8">
    <title>Secretary Dashboard - MedTestLab</title>
    <!-- Bootstrap CSS -->
...
<body>
    <div class="container welcome-container">
        <div class="welcome-message">
            ...
            <p>MedTestLab Secretary Page</p>
        </div>
        <div class="row justify-content-center">
            <div class="col-md-6">
                <div class="form-container">
                    <form action="views_secretary.php" method="post">

                        <div class="form-group">
                            <label for="task">Task:</label>
                            <select id="task" name="task" class="form-control" required>
                                <option value="view_appointments" selected>View Appointments</option>
                                <option value="view_billings">View Billings</option>
